 //graphiqlmysqlConnector
const mysql = require('mysql')
class MySQLConnector {
get MYSQL_DB_USER() { return process.env.MYSQL_DB_USER || 'root' }
get MYSQL_DB_NAME() { return process.env.MYSQL_DB_NAME || 'project' }
...
get MYSQL_DB_POOL_SIZE() { return process.env.MYSQL_DB_POOL_SIZE || 10 }constructor() {
